...
<div className="footer flex flex-col w-full h-96 justify-around items-center relative light bg-white text-primary-color">
       ...
       <div className="flex w-full justify-around items-start">
        <div className="ft1 w-1/4 p-7 flex flex-col gap-2">
          <h1 className="bold text-[24px]">About Modon</h1>
          {/* <h1 className="regular text-[18px]">Call: +123 456 789</h1> */}
          <p className="regular text-[18px]">Modon knows no boundaries for leadership. We work today to shape the future.</p>
        ...
        <div className="ft2 w-1/4 p-7 flex flex-col gap-1">
        ...
        <div className="ft1 w-1/4 p-7 flex flex-col gap-1">
        ...
        <div className="ft1 w-1/4 p-7 flex flex-col gap-1">
          ...
          <p className="regular text-[18px]">Al Mamoon District, Al Nossor Area Near Baghdad Tower, Baghdad, Iraq.</p>
