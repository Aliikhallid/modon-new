...
const loadImages = (project: string,lastImage:number) => {
  ...
  return (
    <div className="project-page flex flex-col h-fit bg-white" dir={`${isRTL? "rtl":"ltr"}`}>
      ...
      <div
        ...
        <p className="md:text-[64px] text-[42px]">Al Sorouh Towers</p>
        </div>
        <p className="md:max-w-[75rem] text-[18px] leading-7 light text-md max-w-[40rem]">The four towers of Sorouh are located at the entrance of Buruj project, and they are distributed in semi-circular shape to ensure the privacy, and to provide wonderful view of the Baghdad International Airport Street, of the green gardens and the landscapes as well, from all the units.</p>
  ...
  <div className={`p-4 relative ${isRTL? "border-l":"border-r"} border-white flex flex-col gap-1 justify-center`}><p className="md:text-[16px] text-[14px] text-primary">Apartment Types</p> <p className="md:text-[14px] text-[10px]">2BHK, 3BHK, 4BHK</p> </div>
    ...
    <h1 className='regular text-md relative mt-40'>DEMONSTRATION ~ SOROUH TOWERS</h1>
    ...
    <div className="flex flex-col h-fit w-fit">
      <div className="flex justify-center items-center regular text-xl text-primary-color mt-10">Sorouh Towers</div>
