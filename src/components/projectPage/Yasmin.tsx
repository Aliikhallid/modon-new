  ...
  return (
    <div className="project-page flex flex-col h-fit bg-white" dir={`${isRTL? "rtl":"ltr"}`}>
      ...
      <div
        ...
        <p className="md:text-[64px] text-[42px]">Yasmin</p>
        </div>
        <p className="md:max-w-[75rem] text-[18px] leading-7 light text-md max-w-[40rem] light">Stylish and comfortable, with parking areas, green yard, balcony, and three master bedrooms with great interior and exterior design.</p>
