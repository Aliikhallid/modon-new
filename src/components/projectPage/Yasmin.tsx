  ...
  return (
    <div className="project-page flex flex-col h-fit t-10 bg-white" dir={`${isRTL? "rtl":"ltr"}`}>
      ...
      <div
        ...
        <p className="md:text-[48px] text-[12px]">Yasmin</p>
        </div>
        <p className="md:max-w-[75rem] light text-md max-w-[40rem]">Stylish and comfortable, with parking areas, green yard, balcony, and three master bedrooms with great interior and exterior design.</p>
