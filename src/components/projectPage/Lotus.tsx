  ...
  return (
    <div className="project-page flex flex-col h-fit bg-white" dir={`${isRTL? "rtl":"ltr"}`}>
      ...
      <div
        ...
        <p className="md:text-[64px] text-[42px]">Lotus</p>
        </div>
        <p className="md:max-w-[75rem] text-[18px] leading-7 light text-md max-w-[40rem]">Lotus Villa is the economical choice. It is a classic Villa with 2 bedrooms and a comfortable living room, a parking space for one car, a green yard and a beautiful balcony on the first floor.</p>
      ...
      <div className="construct1 flex flex-col justify-center items-center">
        <div className="buruj-btns flex flex-wrap justify-center items-center">
         ...
         <div className="videos h-fit relative flex md:flex-row flex-col justify-center items-center">
          ...
          {show===1 ? <div className="flex flex-col md:w-1/2 w-full justify-center items-start light">
