  ...
  return (
    <div className="project-page flex flex-col h-fit t-10 bg-white" dir={`${isRTL? "rtl":"ltr"}`}>
      ...
      <div
        ...
        <p className="md:text-[48px] text-[12px]">Lotus</p>
        </div>
        <p className="md:max-w-[75rem] light text-md max-w-[40rem]">Lotus Villa is the economical choice. It is a classic Villa with 2 bedrooms and a comfortable living room, a parking space for one car, a green yard and a beautiful balcony on the first floor.</p>
