  ...
  return (
    <div className="project-page flex flex-col h-fit t-10 bg-white" dir={`${isRTL? "rtl":"ltr"}`}>
      ...
      <div
        ...
        <p className="md:text-[48px] text-[12px]">Nargis</p>
        </div>
        <p className="md:max-w-[75rem] light text-md max-w-[40rem]">Villas with a modern pattern, that were especially designed to families who are looking for a comfortable housing, characterized by an elegant design, with parking spaces for two cars, green yard and large balcony.</p>
