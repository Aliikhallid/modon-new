  ...
  return (
    <div className="project-page flex flex-col h-fit bg-white" dir={`${isRTL? "rtl":"ltr"}`}>
      ...
      <div
        ...
        <p className="md:text-[64px] text-[42px]">Narjis</p>
        </div>
        <p className="md:max-w-[75rem] text-[18px] leading-7 light text-md max-w-[40rem]">Narjis Villa is the best economic choice. It has three bedrooms, a comfortable living room, a parking space for one car, a green yard and a beautiful balcony on the first floor.</p>
