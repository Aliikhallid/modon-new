  ...
  return (
    <div className="project-page flex flex-col h-fit t-10 bg-white" dir={`${isRTL? "rtl":"ltr"}`}>
      ...
      <div
        ...
        <p className="md:max-w-[75rem] light text-md max-w-[40rem]">The most popular Villas in the compound, which were specially designed for families who are looking for a comfortable Villa with an elegant design, and has a parking space for a car, green yard and a large balcony.</p>
