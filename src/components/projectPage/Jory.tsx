  ...
  return (
    <div className="project-page flex flex-col h-fit bg-white" dir={`${isRTL? "rtl":"ltr"}`}>
      ...
      <div
        ...
        <p className="md:text-[64px] text-[42px]">Jory</p>
        </div>
        <p className="md:max-w-[75rem] leading-7 text-[18px] light text-md max-w-[40rem]">The most luxurious villa in the project, with four bedrooms and a comfortable living room. The villa has two parking spaces and beautiful yard in addition to a large balcony.</p>
      ...
      <div className="construct1 flex flex-col justify-center items-center">
        <div className="buruj-btns flex flex-wrap justify-center items-center">
         ...
         <div className="flex flex-wrap justify-center gap-5 my-20 animate-fade-down animate-duration-1000 animate-delay-500">
          ...
          <h1 className="md:text-5xl regular text-center text-4xl">{title}</h1>
