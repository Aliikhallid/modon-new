    ...
    <div className="constructs flex">
      <div className="construct1 flex flex-col justify-center items-center m-5">
        <div className="buruj-btns">
         ...
         <div className="gallery1 flex flex-col gap-10 transition-all absolute bottom-16 opacity-100">
         ...
         <div className="gallery2 flex flex-col gap-10 transition-all absolute bottom-16">
          <div className="gallery-gallery flex gap-10">
