...
const [selectedImageIndex, setSelectedImageIndex] = useState<number | null>(null);
  ...
  return (
    ...
    <h1 className='regular text-5xl text-primary-color relative mt-20 text-center'>BAYTI UPDATES</h1>
    <div className="constructs flex">
      <div className="construct1 flex flex-col justify-center items-center m-5">
        <div className="buruj-btns text-center">
         <Button className='m-2 upBtn md:w-max w-full' onClick={()=>handleButtonClick("2018","July",20)}>July 2018</Button>
         <Button className='m-2 upBtn md:w-max w-full' onClick={()=>handleButtonClick("2021","October",12)}>October 2021</Button>
         <Button className='m-2 upBtn md:w-max w-full' onClick={()=>handleButtonClick("2022","January",11)}>January 2022</Button>
         <Button className='m-2 upBtn md:w-max w-full' onClick={()=>handleButtonClick("2022","February",17)}>February 2022</Button>
